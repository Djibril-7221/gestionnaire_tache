...
@Injectable()
export class TacheFindOneGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    const estAutorise =
      ...
      tache.destinataire_id === user.id;

    if (!estAutorise) {
      throw new ForbiddenException('Vous n\'êtes pas autorisé à consulter cette tâche');
    }
